a: open_file.cpp output_in_file.cpp sortfile.cpp work_with_file.cpp main.cpp;
...
signed-integer-overflow,undefined,unreachable,vla-bound,vptr open_file.cpp output_in_file.cpp sortfile.cpp work_with_file.cpp main.cpp -o onegin.out